...
def test_blend_arms_endpoints_reproduce_the_two_incumbents():
    ...
    # the arm rounds to 3 decimals, like every other MAE in this module
    assert arms[0.0]["mae_incl_dnp"] == round(20.0 / 3, 3)
    assert arms[1.0]["mae_incl_dnp"] == round(10.0 / 3, 3)
